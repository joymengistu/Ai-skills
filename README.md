...
| Agent Max command router | Compact button- and prompt-friendly command IDs that select minimal Skill bundles, show route previews, point to catalog paths, and preserve host permissions and verification boundaries |
