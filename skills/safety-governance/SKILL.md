...
Use this Skill to improve **safe capability use under uncertainty**. Load it only when that outcome is relevant; do not activate it for unrelated work. The main review surface is risk classification, authority, privacy, misuse, mitigations, monitoring, escalation, and review.
