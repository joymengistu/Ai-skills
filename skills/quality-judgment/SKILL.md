...
Use `references/professional-judgment-contract.md`. Start with the user's purpose, audience, context, realistic content, environment, risk, and quality bar. Convert vague adjectives into observable criteria. Choose only dimensions that matter: clarity, coherence, hierarchy, usefulness, appropriateness, restraint, originality, consistency, memorability, or elegance.
...
Use deterministic checks for measurable properties, a separate critic for structured qualitative review, and human review for preference, cultural context, emotional response, and surprising outcomes. Keep intent, craft, usability, accessibility, resilience, and human-value evidence distinct. Avoid a single magic score. If scoring is useful, retain the dimension breakdown, confidence, examples, evidence source, not-assessable properties, and hard gates.
