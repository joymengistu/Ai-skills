...
Use this Skill to improve **deciding whether a tool earns adoption**. Load it only when that outcome is relevant; do not activate it for unrelated work. The main review surface is real tasks, discovery, permissions, validity, errors, latency, privacy, cost, and end-to-end value.
