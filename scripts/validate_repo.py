...
required = [
    ...
    ROOT / "runtime" / "evidence-ledger.schema.json",
    ROOT / "runtime" / "evidence-ledger.example.json",
    ...
    ROOT / "references" / "knowledge-state-contract.md",
    ROOT / "references" / "artifact-provenance-contract.md",
    ...
    ROOT / "runtime" / "reference_host" / "evidence_ledger.py",
    ROOT / "runtime" / "reference_host" / "test_evidence_ledger.py",
    ROOT / "runtime" / "reference_host" / "artifact_provenance.py",
    ROOT / "runtime" / "reference_host" / "test_artifact_provenance.py",
    ...
    ROOT / "references" / "30-mission-top-tier-roadmap.md",
    ROOT / "references" / "30-mission-execution-ledger.yaml",
    ROOT / "references" / "skill-catalog-capability-map.json",
    ROOT / "references" / "skill-catalog-audit-2026-08-23.md",
    ROOT / "scripts" / "audit_skill_catalog.py",
    ROOT / "contributions" / "master-research-mission-maximum-improvement-original.txt",
    ROOT / "scripts" / "deepen_skills.py",
    ROOT / "scripts" / "test_skill_expansion.py",
    ROOT / "skills" / "screenshot-reconstruction" / "SKILL.md",
    ROOT / "contributions" / "screenshot-reconstruction-mission-original.txt",
